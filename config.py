...
#         type=float,
#         # default=1.0,
#         default=0.0,  # FIX: testing; change back
...
#         "--morpho-warmup",
#         type=int,
#         default=0,  # NOTE: testing, the original value was 60000
...
#         "--disc-warmup",
#         type=int,
#         default=0,  # NOTE: Testing, original value was 20000
...
def parse_args():
    ...
    parser.add_argument(
        "--env-name",
        default="GaitTrackHalfCheetahOriginal-v0",  # NOTE: Testing, original value was "GaitTrackHalfCheetahOriginal-v0"
        help="Mujoco Gym environment",
    )
    parser.add_argument(
        "--method",
    ...
    parser.add_argument(
        "--morpho-warmup",
        type=int,
        default=60000,  # NOTE: testing, the original value was 60000
        help="Steps before starting to optimize for morphology",
    )
    parser.add_argument(
        "--episodes-per-morpho",
    ...
    parser.add_argument(
        "--disc-warmup",
        type=int,
        default=20000,  # NOTE: Testing, original value was 20000
        help="Steps before starting to train SAC",
    )
    parser.add_argument(
        "--record-test", type=bool, default=False, help="Record tests (may be slow)"
    ...
    parser.add_argument(
        "--co-adapt",
        type=bool,
        default=False,  # NOTE: Testing; original value was False
        help="Adapt morphology as well as behaviour",
    )
    parser.add_argument(
        "--expert-env-name", type=str, default=None, help="Expert env name"
