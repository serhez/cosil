# From https://github.com/google-research/google-research/tree/master/pwil
# Not used for paper experiments but included for completeness
...
class PWILRewarder(object):
  ...
  def __init__(self,
    ...
    self.reward_sigma = beta * time_horizon / np.sqrt(dim_obs)
    ...
    for demo in demonstrations:
        demos += [{'observation': d} for d in demo.cpu().numpy()]
